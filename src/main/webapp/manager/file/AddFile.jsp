	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-8" align="center" style="text-align: center;">
				<form class="form-inline" action="PatientList.html" method="get">
						<table align="center" class="table  table-bordered" style="width:60%;">
							<tr class="bg-info">
								<td style="text-align: center;" colspan="3"><span style="font-size: 20px;font-weight: bold;">文档上传</span></td>
							</tr>
							<tr class="active">
								<td style="width: 15%; vertical-align: middle">患者姓名</td>
								<td colspan="2"><input type="file" style="width: 90%;"  class="form-control" name="" ></td>
							</tr>
							
							<tr>
								<td colspan="3"><input type="submit" style="width: 200px;" class="btn btn-success" value="上传"></td>
							</tr>
						</table>
					</form>
			</div>
